...
const SPECIAL_TRANSFER_UNTIL=Date.parse('2026-09-18T14:17:20+02:00');
function transferWindowState(now=Date.now()){
  ...
  if(now<SPECIAL_TRANSFER_UNTIL)return{open:true,targetGw:2,penalty:false,special:true,closes_at:new Date(SPECIAL_TRANSFER_UNTIL).toISOString(),message:'Special 3-minute transfer window is OPEN. GW2 transfers are free.'};
