// FantasyX temporary transfer window: open until 1:43 PM Johannesburg time on 17 Sep 2026.
(function(){
  const DEADLINE=Date.parse('2026-09-17T13:43:00+02:00');
  ...
  function syncTransferDeadline(){
    ...
    try{TRANSFERS_LOCKED=!open;TRANSFER_REASON=open?'':'Transfers closed at the 1:43 PM kickoff.';}catch{}
    ...
    document.querySelectorAll('.transferDeadlineText').forEach(el=>{el.innerHTML=open?`Transfers open until <b>1:43 PM</b> · ${remaining} min remaining`:'Transfers are <b>closed</b> for this gameweek.'});
